...
begin
  ...
  into missing_tables
  from (values
    ('organizations'), ('profiles'), ('farms'), ('flocks'), ('daily_records'),
...
select count(*) as restored_daily_records from public.daily_records;
...
begin
  ...
  where n.nspname = 'public'
    and c.relname in ('organizations', 'profiles', 'farms', 'daily_records', 'inventory_items', 'stock_ledger', 'governance_audit_events')
