-- Keep manager email for Auth user creation, but do not insert email into profiles
-- because profiles table in this environment has no email column.
-- Persist manager phone in profiles instead.
