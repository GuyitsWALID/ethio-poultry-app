...
test("Addis cutoff leaves yesterday open before 10 and locks it from 10",()=>{assert.equal(operatingDayLockBoundary(new Date("2026-08-04T06:59:00Z"),"10:00:00"),"2026-08-02");assert.equal(operatingDayLockBoundary(new Date("2026-08-04T07:00:00Z"),"10:00:00"),"2026-08-03")});
