...
export default function AlertsPage() {
  ...
  return <main className="space-y-5 pb-8">
    ...
    <section className="overflow-hidden rounded-2xl border border-sand-200 bg-white shadow-sm">
      ...
      <div className="divide-y divide-sand-100">{loading ? <div className="p-10 text-center text-sm text-forest-600">Collecting and reconciling operational actions…</div> : visible.length ? visible.map((item) => <article key={item.actionId} className="p-5 sm:p-6">
